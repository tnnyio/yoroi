...
func TestHTTPClient(t *testing.T) {
	var (
		testbody = "testbody"
		encode   = func(context.Context, *http.Request, Req) error { return nil }
		decode   = func(_ context.Context, r *http.Response) (Res, error) {
	...
	client := httpTransport.NewClient[Req, Res](
		"GET",
		mustParse(server.URL),
		encode,
		decode,
		httpTransport.ClientBefore[Req, Res](httpTransport.SetRequestHeader(headerKey, headerVal)),
		httpTransport.ClientAfter[Req, Res](afterFunc),
	)
...
func TestHTTPClientBufferedStream(t *testing.T) {
	...
	client := httpTransport.NewClient(
		...
		encode,
		decode,
		httpTransport.BufferedStream[Req, Res](true),
	)
...
func TestClientFinalizer(t *testing.T) {
	...
	client := httpTransport.NewClient(
		...
		encode,
		decode,
		httpTransport.ClientFinalizer[Req, Res](func(ctx context.Context, err error) {
...
func TestEncodeJSONRequest(t *testing.T) {
	...
	for _, test := range []struct {
		...
		if _, err := client(context.Background(), test.value); err != nil {
			t.Error(err, fmt.Errorf(fmt.Sprintf("%v", test.value)))
			continue
		}
...
func TestSetClient(t *testing.T) {
	...
	client := httpTransport.NewClient(
		...
		encode,
		decode,
		httpTransport.SetClient[Req, Res](testHttpClient),
	).Endpoint()
