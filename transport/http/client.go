...
func NewClient[I, O interface{}](method string, tgt *url.URL, enc EncodeRequestFunc[I], dec DecodeResponseFunc[O], options ...ClientOption[I, O]) *Client[I, O] {
	return NewExplicitClient[I, O](makeCreateRequestFunc[I](method, tgt, enc), dec, options...)
}
...
func NewExplicitClient[I, O interface{}](req CreateRequestFunc[I], dec DecodeResponseFunc[O], options ...ClientOption[I, O]) *Client[I, O] {
	c := &Client[I, O]{
...
func SetClient[I, O interface{}](client HTTPClient) ClientOption[I, O] {
...
func ClientBefore[I, O interface{}](before ...RequestFunc) ClientOption[I, O] {
...
func (c Client[I, O]) Endpoint() endpoint.Endpoint[O] {
	return func(ctx context.Context, request interface{}) (response O, err error) {
		...
		var _req I
		{
			...
			if !ok && request != nil {
				cancel()
				return response, transport.InvalidRequest
			}
		}
		req, err := c.req(ctx, _req)
		if err != nil {
			cancel()
			return response, err
		}
...
func makeCreateRequestFunc[I interface{}](method string, target *url.URL, enc EncodeRequestFunc[I]) CreateRequestFunc[I] {
	return func(ctx context.Context, request I) (*http.Request, error) {
