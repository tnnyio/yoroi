...
type EncodeRequestFunc[Request interface{}] func(*fh.RequestCtx, Request) error
...
type CreateRequestFunc[Request interface{}] func(*fh.RequestCtx, Request) (*fh.RequestCtx, error)
...
type DecodeResponseFunc[Response interface{}] func(*fh.RequestCtx) (response Response, err error)
