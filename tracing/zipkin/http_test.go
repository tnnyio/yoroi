...
import (
	...
	zipkinYoroi "github.com/tnnyio/yoroi/tracing/zipkin"
...
func TestHTTPClientTracePropagatesParentSpan(t *testing.T) {
	...
	clientTracer := zipkinYoroi.HTTPClientTrace[interface{}, interface{}](tr)
...
func testHTTPClientTraceCase(t *testing.T, responseStatusCode int, errTagValue string) {
	...
	clientTracer := zipkinYoroi.HTTPClientTrace[interface{}, interface{}](
		tr,
		zipkinYoroi.Name(testName),
		zipkinYoroi.Tags(map[string]string{testTagKey: testTagValue}),
	)
...
func TestHTTPServerTrace(t *testing.T) {
	...
	handler := httpTransport.NewServer(
		...
		zipkinYoroi.HTTPServerTrace[interface{}, interface{}](tr),
	)
...
func TestHTTPServerTraceIsRequestBasedSampled(t *testing.T) {
	...
	handler := httpTransport.NewServer(
		...
		zipkinYoroi.HTTPServerTrace[interface{}, interface{}](tr, zipkinYoroi.RequestSampler(func(r *http.Request) bool {
