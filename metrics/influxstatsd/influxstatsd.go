...
import (
	...
	"github.com/tnnyio/yoroi/metrics"
	"github.com/tnnyio/yoroi/metrics/generic"
	"github.com/tnnyio/yoroi/metrics/internal/lv"
	"github.com/tnnyio/yoroi/metrics/internal/ratemap"
	"github.com/tnnyio/yoroi/util/conn"
)
...
func New(prefix string, logger log.Logger, lvs ...string) *Influxstatsd {
	...
	return &Influxstatsd{
		...
		gauges:     map[string]*gaugeNode{}, // https://github.com/tnnyio/yoroi/pull/588
		timings:    lv.NewSpace(),
